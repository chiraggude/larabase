...
<div class="row">
    <div class="col-md-12">
        ...
        <a href="{{ URL::to('#') }}" class="btn btn-xs btn-default pull-right"><i class="fa fa-edit"></i> Edit Security Settings</a>

        {{ HTML::br(3) }}

        <h3><i class="fa fa-exchange"></i> Notifications</h3>
        {{ HTML::table($settings, ['Setting 1', 'Setting 2', 'Setting 3', 'Setting 4', 'Setting 5']) }}
        <a href="{{ URL::to('#') }}" class="btn btn-xs btn-default pull-right"><i class="fa fa-edit"></i> Edit Notifications Settings</a>

        {{ HTML::br(5) }}

        <a href="{{ URL::to('password/change') }}" class="btn btn-default"><i class="fa fa-lock"></i> Change Account Password</a>
        <a href="{{ URL::to('#') }}" class="btn btn-default"><i class="fa fa-users"></i> Social Accounts</a>
        ...
        <a class="btn btn-sm btn-danger" href="{{ URL::to('#') }}"><i class="fa fa-power-off"></i> Deactivate Account</a>
        @else
