...
class AccountController extends Controller {
    ...
    public function dashboard()
    {
        ...
        return view('account.dashboard', compact('user','user_posts'));
    }
    ...
    public function settings()
    {
        ...
        return view('account.settings', compact('user', 'example_settings', 'example_values'));
    }
    ...
    public function settingsEdit()
    {
        ...
        return view('account.settings-edit', compact('user', 'timezones'));
    }
